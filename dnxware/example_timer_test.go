...
var (
	requestDuration = dnxware.NewHistogram(dnxware.HistogramOpts{
		Name:    "example_request_duration_seconds",
		Help:    "Histogram for the runtime of a simple example function.",
		Buckets: dnxware.LinearBuckets(0.01, 0.01, 10),
	})
)
...
func ExampleTimer() {
	...
	// https://dnxware.io/docs/practices/histograms/ for differences.
	timer := dnxware.NewTimer(requestDuration)
