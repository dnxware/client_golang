...
// Copyright (c) 2013, The dnxware Authors
// All rights reserved.
//
// Use of this source code is governed by a BSD-style license that can be found
// in the LICENSE file.

package dnxware_test
...
func (u uncheckedCollector) Describe(_ chan<- *dnxware.Desc) {}
func (u uncheckedCollector) Collect(c chan<- dnxware.Metric) {
	u.c.Collect(c)
}
...
func testHandler(t testing.TB) {
	...
	metricVec := dnxware.NewCounterVec(
		dnxware.CounterOpts{
			Name:        "name",
			Help:        "docstring",
			ConstLabels: dnxware.Labels{"constname": "constvalue"},
		},
		[]string{"labelname"},
	)
...
`)
	...
	summary := dnxware.NewSummary(dnxware.SummaryOpts{
		Name: "complex",
...
complex_count 0
`)
	histogram := dnxware.NewHistogram(dnxware.HistogramOpts{
		Name: "complex",
...
`)
	...
	var scenarios = []struct {
		...
		{ // 2
			headers: map[string]string{
				"Accept": "foo/bar;q=0.2, application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=bla;q=0.8",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `text/plain; version=0.0.4; charset=utf-8`,
		...
		{ // 3
			headers: map[string]string{
				"Accept": "text/plain;q=0.2, application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=delimited;q=0.8",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `application/vnd.google.protobuf; proto=io.dnxware.client.MetricFamily; encoding=delimited`,
				},
				body: []byte{},
			},
		},
		...
		{ // 5
			headers: map[string]string{
				"Accept": "application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=delimited",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `application/vnd.google.protobuf; proto=io.dnxware.client.MetricFamily; encoding=delimited`,
		...
		{ // 10
			headers: map[string]string{
				"Accept": "application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=bla;q=0.2, text/plain;q=0.5",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `text/plain; version=0.0.4; charset=utf-8`,
		...
		{ // 11
			headers: map[string]string{
				"Accept": "application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=bla;q=0.2, text/plain;q=0.5;version=0.0.4",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `text/plain; version=0.0.4; charset=utf-8`,
		...
		{ // 12
			headers: map[string]string{
				"Accept": "application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=delimited;q=0.2, text/plain;q=0.5;version=0.0.2",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `application/vnd.google.protobuf; proto=io.dnxware.client.MetricFamily; encoding=delimited`,
		...
		{ // 13
			headers: map[string]string{
				"Accept": "application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=text;q=0.5, application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=delimited;q=0.4",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `application/vnd.google.protobuf; proto=io.dnxware.client.MetricFamily; encoding=text`,
				},
				body: bytes.Join(
					[][]byte{
		...
		{ // 14
			headers: map[string]string{
				"Accept": "application/vnd.google.protobuf;proto=io.dnxware.client.MetricFamily;encoding=compact-text",
			},
			out: output{
				headers: map[string]string{
					"Content-Type": `application/vnd.google.protobuf; proto=io.dnxware.client.MetricFamily; encoding=compact-text`,
				},
				body: bytes.Join(
					[][]byte{
	...
	for i, scenario := range scenarios {
		registry := dnxware.NewPedanticRegistry()
		gatherer := dnxware.Gatherer(registry)
		if scenario.externalMF != nil {
			gatherer = dnxware.Gatherers{
				registry,
				dnxware.GathererFunc(func() ([]*dto.MetricFamily, error) {
		...
		handler := dnxware.InstrumentHandler("dnxware", promhttp.HandlerFor(gatherer, promhttp.HandlerOpts{}))
...
func TestAlreadyRegistered(t *testing.T) {
	reg := dnxware.NewRegistry()
	original := dnxware.NewCounterVec(
		dnxware.CounterOpts{
			Name: "test",
			Help: "help",
		},
	...
	equalButNotSame := dnxware.NewCounterVec(
		dnxware.CounterOpts{
			Name: "test",
			Help: "help",
		},
	...
	if are, ok := err.(dnxware.AlreadyRegisteredError); ok {
...
func TestHistogramVecRegisterGatherConcurrency(t *testing.T) {
	...
	var (
		reg = dnxware.NewPedanticRegistry()
		hv  = dnxware.NewHistogramVec(
			dnxware.HistogramOpts{
				Name:        "test_histogram",
				Help:        "This helps testing.",
				ConstLabels: dnxware.Labels{"foo": "bar"},
			},
			labelNames,
		)
		...
		for {
			...
			default:
				if err := reg.Register(hv); err != nil {
					if _, ok := err.(dnxware.AlreadyRegisteredError); !ok {
...
`
	...
	registry := dnxware.NewRegistry()

	summary := dnxware.NewSummaryVec(
		dnxware.SummaryOpts{
			Name: "test_summary",
			Help: "test summary",
		},
	...
	histogram := dnxware.NewHistogramVec(
		dnxware.HistogramOpts{
			Name: "test_hist",
			Help: "test histogram",
		},
	...
	summary.With(dnxware.Labels{"name": "foo"}).Observe(10)
	summary.With(dnxware.Labels{"name": "foo"}).Observe(20)
	histogram.With(dnxware.Labels{"name": "bar"}).Observe(0.93)
	histogram.With(dnxware.Labels{"name": "bar"}).Observe(2.71)
	gauge.With(dnxware.Labels{"name": "baz"}).Set(1.1)
	counter.With(dnxware.Labels{"name": "qux"}).Inc()
	...
	if err := dnxware.WriteToTextfile(tmpfile.Name(), registry); err != nil {
		t.Fatal(err)
	}
