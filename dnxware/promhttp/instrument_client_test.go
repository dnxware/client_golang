...
func makeInstrumentedClient() (*http.Client, *dnxware.Registry) {
	...
	dnsLatencyVec := dnxware.NewHistogramVec(
	...
	tlsLatencyVec := dnxware.NewHistogramVec(
		dnxware.HistogramOpts{
...
func ExampleInstrumentRoundTripperDuration() {
	...
	dnxware.MustRegister(counter, tlsLatencyVec, dnsLatencyVec, histVec, inFlightGauge)
